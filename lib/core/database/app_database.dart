...
class AppDatabase {
  ...
  Future<void> _insertDefaultCategories(Database db) async {
    final categories = [
      {
        'code': 'adult_choking',
        'name_en': 'Adult Choking',
        'name_ar': 'اختناق بالغ',
      },
      {
        'code': 'child_choking',
        'name_en': 'Child Choking',
        'name_ar': 'اختناق طفل',
      },
      {'code': 'asthma', 'name_en': 'Asthma Attack', 'name_ar': 'نوبة ربو'},
      {
        'code': 'anaphylaxis',
        'name_en': 'Severe Allergy',
        'name_ar': 'حساسية شديدة',
      },
      {
        'code': 'unconscious_breathing',
        'name_en': 'Unconscious Breathing',
        'name_ar': 'فاقد الوعي ويتنفس',
      },
      {
        'code': 'not_breathing_cpr',
        'name_en': 'Not Breathing / CPR',
        'name_ar': 'لا يتنفس / إنعاش',
      },
    ...
    final steps = [
      {
        ...
        'body_ar':
            'اسأل "هل تختنق؟" إذا لم يستطع الكلام أو السعال — تصرف فوراً.',
      },
      {
        'category_code': 'adult_choking',
        'step_no': 2,
        ...
        'body_en':
            'Lean them forward. Strike firmly between shoulder blades 5 times with the heel of your hand.',
      ...
      },
      {
        ...
        'body_en':
            'Stand behind them, make a fist above the navel, and thrust sharply inward and upward 5 times.',
        'body_ar':
            'قف خلفه، ضع قبضتك فوق السرة، وادفع بقوة للداخل والأعلى 5 مرات.',
      },
      {
        'category_code': 'adult_choking',
        'step_no': 4,
        ...
        'body_en':
            'Alternate 5 back blows and 5 thrusts. If unconscious, call emergency services and start CPR.',
        'body_ar':
            'بادل بين 5 ضربات ظهر و5 دفعات. إذا فقد الوعي اتصل بالطوارئ وابدأ الإنعاش.',
      },
      {
        ...
        'body_en':
            'If the child cannot cry, cough or breathe, begin first aid immediately.',
        'body_ar':
            'إذا لم يستطع البكاء أو السعال أو التنفس، ابدأ الإسعاف فوراً.',
      },
      {
        'category_code': 'child_choking',
        'step_no': 2,
        'title_en': '5 back blows',
        'title_ar': '5 ضربات ظهر',
        'body_en':
            'Lay child face-down on your forearm. Support head. Give 5 firm back blows.',
        'body_ar':
            'ضع الطفل وجهه للأسفل على ساعدك. دعم الرأس. أعطِ 5 ضربات ظهر قوية.',
      },
      {
        'category_code': 'child_choking',
        'step_no': 3,
        ...
        'body_en':
            'Turn child face-up. Give 5 chest thrusts with 2 fingers on center of chest.',
        'body_ar':
            'اقلب الطفل وجهه للأعلى. أعطِ 5 دفعات صدرية بإصبعين على مركز الصدر.',
      },
      {
        ...
        'body_en':
            'Sit the person upright, leaning slightly forward. Do not lay them down.',
      ...
      },
      {
        ...
        'body_en':
            'Help them use their reliever inhaler. One puff every 30-60 seconds, up to 10 puffs.',
        'body_ar':
            'ساعده على استخدام بخاخ الإغاثة. نفخة كل 30-60 ثانية، حتى 10 نفخات.',
      },
      {
        ...
        'body_en':
            'If available, use an epinephrine auto-injector on outer thigh immediately.',
        'body_ar':
            'إذا كانت متوفرة، استخدم حقنة الأدرينالين على الفخذ الخارجي فوراً.',
      },
      {
        'category_code': 'anaphylaxis',
        'step_no': 2,
        'title_en': 'Call emergency services',
        'title_ar': 'اتصل بالطوارئ فوراً',
        'body_en':
            'Call emergency services immediately even if symptoms improve.',
        'body_ar': 'اتصل بالإسعاف فوراً حتى لو تحسنت الأعراض.',
      },
      {
        ...
        'body_en':
            'Tap shoulders and shout "Are you okay?" If no response, call emergency services.',
        'body_ar':
            'اربت على الكتفين واصرخ "هل أنت بخير؟" إذا لم يستجب، اتصل بالطوارئ.',
      },
      {
        'category_code': 'unconscious_breathing',
        'step_no': 2,
        ...
        'body_en':
            'Roll them on their side to keep airway clear and prevent choking.',
        'body_ar': 'اقلبه على جانبه للحفاظ على مجرى الهواء ومنع الاختناق.',
      },
      {
        'category_code': 'not_breathing_cpr',
        'step_no': 1,
        'title_en': 'Call emergency services now',
        'title_ar': 'اتصل بالطوارئ الآن',
        'body_en':
            'Call emergency services immediately or ask someone nearby to call while you begin CPR.',
        'body_ar':
            'اتصل بالطوارئ فوراً أو اطلب من شخص قريب الاتصال بينما تبدأ الإنعاش.',
      },
      {
        'category_code': 'not_breathing_cpr',
        'step_no': 2,
        ...
        'body_en':
            'Push down hard and fast. At least 5cm deep, 100-120 compressions per minute.',
        'body_ar':
            'اضغط بقوة وسرعة. عمق 5 سم على الأقل، 100-120 ضغطة في الدقيقة.',
      },
    ];
  ...
  Future<List<Map<String, dynamic>>> getStepsByCategory(
    String categoryCode,
  ) async {
    final db = await database;
    return db.query(
