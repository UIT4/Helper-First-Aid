  ...
  Future<void> _insertDefaultSteps(Database db) async {
    final steps = [
      ...
      },
      {
        ...
        'body_en': 'Alternate 5 back blows and 5 thrusts. If unconscious, call emergency services and start CPR.',
        'body_ar': 'بادل بين 5 ضربات ظهر و5 دفعات. إذا فقد الوعي اتصل بالطوارئ وابدأ الإنعاش.',
      },
      {
      ...
      },
      {
        ...
        'body_en': 'Help them use their reliever inhaler. One puff every 30-60 seconds, up to 10 puffs.',
        'body_ar': 'ساعده على استخدام بخاخ الإغاثة. نفخة كل 30-60 ثانية، حتى 10 نفخات.',
      },
      {
        ...
        'body_en': 'If available, use an epinephrine auto-injector on outer thigh immediately.',
      ...
      },
      {
        ...
        'body_en': 'Call emergency services immediately even if symptoms improve.',
      ...
      },
      {
        ...
        'body_en': 'Tap shoulders and shout "Are you okay?" If no response, call emergency services.',
        'body_ar': 'اربت على الكتفين واصرخ "هل أنت بخير؟" إذا لم يستجب، اتصل بالطوارئ.',
      },
      {
        'category_code': 'unconscious_breathing',
        'step_no': 2,
        ...
        'body_en': 'Roll them on their side to keep airway clear and prevent choking.',
      ...
      },
      {
        ...
        'body_en': 'Call emergency services immediately or ask someone nearby to call while you begin CPR.',
        'body_ar': 'اتصل بالطوارئ فوراً أو اطلب من شخص قريب الاتصال بينما تبدأ الإنعاش.',
      },
      {
        'category_code': 'not_breathing_cpr',
        'step_no': 2,
